"""
Description: Évaluation précise de la métrique PR-AUC spécifiquement sur les transactions de type 'op_03'.
...
print(f"XGBoost Validation PR-AUC (standard): {val_pr_auc:.6f}")
