...
# Counts per period
combined['orig_count_per_period'] = combined.groupby(['origin_account', 'period']).transform('size')
combined['dest_count_per_period'] = combined.groupby(['destination_account', 'period']).transform('size')
...
features = [
    ...
    "orig_count_per_period", "dest_count_per_period",
...
print(f"PR-AUC with counts per period: {score:.6f}")
