"""
Description: Entraînement et évaluation d'un modèle XGBoost sur le jeu de validation temporelle.
...
params = {
    ...
    "seed": 42,
    "tree_method": "hist"  # Fast hist method, supports categorical natively
}
...
print(f"XGBoost Validation PR-AUC: {val_pr_auc:.6f}")
