...
configs = [
    {"seed": 42, "max_depth": 6, "learning_rate": 0.08, "subsample": 0.8, "rounds": 118},
    {"seed": 123, "max_depth": 6, "learning_rate": 0.08, "subsample": 0.8, "rounds": 118},
    {"seed": 1337, "max_depth": 6, "learning_rate": 0.08, "subsample": 0.8, "rounds": 118},
    {"seed": 2026, "max_depth": 6, "learning_rate": 0.08, "subsample": 0.75, "rounds": 117},
    {"seed": 999, "max_depth": 7, "learning_rate": 0.08, "subsample": 0.8, "rounds": 84}
]

preds = []

for i, cfg in enumerate(configs):
    print(f"Training Model {i+1}/5: {cfg}...")
    params = {
    ...
    print(f"Model {i+1} PR-AUC: {score:.6f}")

mean_pred = np.mean(preds, axis=0)
ensemble_score = average_precision_score(y_val, mean_pred)
print(f"\nEnsemble of 5 XGBoosts PR-AUC: {ensemble_score:.6f}")
